...
(when (load "flymake" t)
  (defun flymake-pylint-init ()
    (let* ((temp-file (flymake-init-create-temp-buffer-copy
      ...
      (list "~/code/10stories/run_pylint.sh" (list local-file))))
...
;; Launch the edit server to listen to terminal and git edit commands
(server-start)
...
;; Disable bell only when scrolling to end of buffer
